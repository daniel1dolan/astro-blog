export const posts = [
  ...
  },
  {
    body:
      "\n" +
      "\n" +
      "If you’re looking for a loyal, goofy, and affectionate pup, look no further than the corgi! These low-to-the-ground pooches have been gaining popularity over recent years, and it’s no surprise why. With their signature short legs, big ears, and smushy faces, corgis are simply adorable and hard to resist.\n" +
      "\n" +
      "Not only are corgis a pleasure to look at, their personalities are just as delightful. These dogs are loyal, intelligent, and eager to please. They’re also quite active and love to play, making them an ideal companion for active families.\n" +
      "\n" +
      "Corgis come in two varieties: the Pembroke Welsh Corgi and the Cardigan Welsh Corgi. The Pembroke is the more popular of the two, and is known for its stubby legs and pointed ears. The Cardigan is slightly larger and has a more rounded face and longer legs. Both breeds are loyal, friendly, and love to play.\n" +
      "\n" +
  ...
  },
  {
    body:
      "\n" +
      "\n" +
      "Are you looking for a cat that will bring you lots of joy and excitement? Consider getting a Bengal cat! Bengals are a hybrid breed of domestic cat that have an exotic appearance, often referred to as a “little leopard”. They are extremely playful, affectionate, and intelligent cats that make great family pets.\n" +
      "\n" +
      "Bengals have a unique appearance, with a thick coat of “glittery” fur that could be compared to that of a wild leopard. Bengals are usually brown or black with distinctive markings, such as spots, stripes, or rosettes. They have a powerful and athletic build, with strong hind legs, which allows them to be great jumpers and climbers.\n" +
      "\n" +
      "In terms of personality, Bengals are known for being very social and interactive cats. They love to play, and they love to be around their family. Bengals can be quite vocal and they often greet their owners with a low chirping sound. They are also very intelligent and can be trained to do tricks such as fetch and come when called.\n" +
      "\n" +
  ...
  },
  {
    body:
      "\n" +
      "\n" +
      "Ah, the beloved Doge. It started as a meme, but has since become a beloved icon for many people over the years. The Doge meme, featuring a Shiba Inu dog with a comical expression and broken English, has been around since 2013 and has become a popular Internet sensation.\n" +
      "\n" +
      "Doge has been used in countless memes, videos, and even online currency. People have taken a liking to Doge and have even created their own Dogecoin, which has become a popular form of digital currency.\n" +
      "\n" +
      "Doge has become so popular because of its unique look and personality. People love its silly expressions and its broken English. Doge’s popularity has even led to the creation of its own merchandise, including t-shirts and mugs.\n" +
      "\n" +
